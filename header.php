                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="category.html" aria-label="Toggle navigation">Telegram</a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="category.html" aria-label="Toggle navigation">Aportes</a>
                                    </li>
                            ...
                            <div class="login-button">
                                <ul>
                                    <li>
                                        <a href="login.html"><i class="lni lni-enter"></i> Iniciar Sesión</a>
                                    </li>
                                    <li>
                                        <a href="registration.html"><i class="lni lni-user"></i>Registrar</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="button header-button">
                                <a href="post-item.html" class="btn">Mi perfil</a>
                            </div>
                        </nav>
                    </div>
                </div>
